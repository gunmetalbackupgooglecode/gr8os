...
Jim Boemler (jboemler@halcyon.com)
  ...
  This header created on Mon Sep 17 09:45:53 PDT 2007
...
PCI_VENTABLE	PciVenTable [] =
{
	...
	{ 0x1039, "SiS7013 56k modem", "Silicon Integrated Systems" } ,
	...
	{ 0x1106, "VIA  ac'97 enhanced", "VIA Technology   vt8375" } ,
...
PCI_DEVTABLE	PciDevTable [] =
{
	...
	{ 0x3D3D, 0x3D07, "Permedia", "2D+3D Accelerator" } ,
	...
	{ 0x5333, 0x8901, "PCI\\ven_5333dev_9102ubsys_91025333rev_02", "Trio64V2/DX-/GX Graphics Drivers" } ,
	...
	{ 0x8086, 0x1092, "82562GZ", "PRO/100 VE Network Controller" } ,
	...
	{ 0x8086, 0x2415, "Intel 82801DBM IDE Controller (UltraATA/100)", "Aureal (AD1881 SOUNDMAX) Placa Ma~e Asaki P3-141" } ,
	...
	{ 0x8086, 0x24C5, "intel 82801DB(-M) - AC'97 Audio Controller [B-0]", "SoundMAX Integrated Digital Controller" } ,
	...
	{ 0x8086, 0x2668, "8181104", "Realtek High Definition Audio Controllers" } ,
	{ 0x8086, 0x266A, "82801BA/CA", "SMBus Controller" } ,
	{ 0x8086, 0x266C, "82801FB/FR/FW/FRW", "LAN Controller" } ,
	{ 0x8086, 0x266D, "Intel 82801AA ICH2X", "Realtek ALC655 @ Intel 82801DFBM ICH6-M - AC'97 Audio Controller [B-1]	PCI" } ,
	...
	{ 0x8086, 0x27d8, "72101462", "Microsoft UAA Bus HD Audio" } ,
	{ 0x8086, 0x27d8, "27", "Microsoft UAA Bus HD Audio" } ,
	{ 0x8086, 0x27DA, "82801G", "SMBus Controller" } ,
	...
	{ 0x8086, 0x284B, "82801H", "&SUBSYS_81EC1043&REV_02\3&11583659&0&D8" } ,
	...
	{ 0x8086, 0x4222, "14F1", "Intel 3945ABG Wireless LAN controller" } ,
	...
	{ 0x1180, 0x0592, "4293196", "Ricoh Memory Stick Host Controller" } ,
	...
	{ 0x14F1, 0x2F20, "?", "RC415ST-mh" } ,
	{ 0x14F1, 0x2F30, "rc415st-hm", "hp/compaq alhena 5-gl6" } ,
	{ 0x14F1, 0x2F40, "????", "Conexant Modem?" } ,
	{ 0x14F1, 0x5045, "0x173410AD", "HDAUDIO Soft Data fax Modem with SmartPC" } ,
	{ 0x14F1, 0x5042, "1179FF31", "High Definition Audio Func02" } ,
	...
	{ 0x168C, 0x001A, "Atheros AR5005G", "Atheros AR5005G 802.11abg NIC Chipset / TP-Link (TL-WN551G) http://www.tp-link.com/product/download/" } ,
	...
	{ 0x1002, 0x4742, "(GT-C2U2)", "ATI  Rage Pro  AGP 2X 2mb" } ,
	...
	{ 0x1013, 0x1013, "cs4610", "accelerator do audio do pci de sound fusion" } ,
	...
	{ 0x1013, 0x6003, "CS4614/22/24/", "CrystalClear SoundFusion  Audio Accelerator" } ,
	...
	{ 0x1023, 0x9682, "TGUI9440", "Trident A CAB01" } ,
	...
	{ 0x1043, 0x0675, "P4P-800X", "Cologne Chip" } ,
	...
	{ 0x104C, 0x8201, "not able to find - where is it?", "TI UltraMedia Firmware Loader Device" } ,
	...
	{ 0x1057, 0x3052, "SM56", "Motorola SM56 Software Speakerphone Modem" } ,
	...
	{ 0x10B9, 0x5237, "M5273 A1 for windows win me", "OpenHCI 1.1 USB to  2.0" } ,
	...
	{ 0x10EC, 0x0262, "ALC262", "Realtek High Definition Audio" } ,
	...
	{ 0x10EC, 0x8139, "RTL8136", "10/100 Mbps Fast Ethernet NIC" } ,
	...
	{ 0x1106, 0x0571, "VT82C596x", "Sound Card drivers" } ,
	...
	{ 0x1106, 0x3058, "VT82C6", "AC97 Audio Codec (All VIA Chipsets)" } ,
	{ 0x1106, 0x3059, "VT8237A", "AC97 Enhanced Audio Controller - the 8251 controller is different" } ,
	...
	{ 0x1106, 0x3349, "VT8251", "VIA South Bridge (SATA/Raid)" } ,
	...
	{ 0x1462, 0x4720, "Realtek AC97", "Audio controller" } ,
	...
	{ 0x14E4, 0x164C, "5708C", "Broadcom NetXtreme II Gigabit Ethernet Adapter" } ,
	...
	{ 0x14E4, 0x16FD, "N.A.", "NetXtreme Gigabit Ethernet PciXpress" } ,
	...
	{ 0x14E4, 0x4311, "BCM4311", "Broadcom 802.11a/b/g WLAN" } ,
	...
	{ 0x1131, 0x7130, "SAA7135HL", "Bus 2, pe'riphe'rique 11, fonction 0 Philips SAA7130HL Multimedia Capture Device" } ,
	{ 0x1131, 0x7133, "Philips SAA7130hl", "ENLTV TV/Radio Tuner" } ,
	{ 0x1131, 0x7134, "SAA7130HL", "Multi Media Capture Device" } ,
	{ 0x1131, 0x7145, "SAA7145ah", "Multimedia audio controler" } ,
	{ 0x1131, 0x7146, "i845E", "TT-budget® S-1401" } ,
	...
	{ 0x11BD, 0xBEBE, "51015777", "pinnacle, bendino V1.0A; 0PC0P6" } ,
	...
	{ 0x11C1, 0x3026, "?", "Agere Systems HDA Modem" } ,
