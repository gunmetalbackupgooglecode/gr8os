...
//    UPDATE_SEQUENCE_ARRAY UpdateSequenceArray;                      //  offset = 0x028
    ULONG UpdateSequenceArray;                      //  offset = 0x028
...
#define NtfsGetNextRecord(STRUCT) (                    \
    (PATTRIBUTE_RECORD_HEADER)((PUCHAR)(STRUCT) + (STRUCT)->RecordLength) \
)
...
#define NtfsGetValue(ATTRIBUTE) ((PINDEX_ROOT)                                \
